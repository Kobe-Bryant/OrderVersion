...
//	NSLog(@"sns id %@",[Common getVersion:HOT_RECOMMENDED_ID]);
	NSDictionary *jsontestDic = [NSDictionary dictionaryWithObjectsAndKeys:[Common getVersion:HOT_RECOMMENDED_ID],@"ver",[NSNumber numberWithInt:shop_id],@"shop-id",[NSNumber numberWithInt: site_id],@"site-id",nil];
