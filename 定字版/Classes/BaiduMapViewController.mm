...
////            pointAnnotationForRemove = [[BMKPointAnnotation alloc]init];
////        }
////        pointAnnotationForRemove.coordinate = result.geoPt;
////        pointAnnotationForRemove.title = result.strAddr;
////        [_mapView addAnnotation:pointAnnotationForRemove];
////        //[pointAnnotationForRemove release];
////        
////        if (mapDelegate != nil) {
////            [mapDelegate getMarkAddress:result.strAddr];
