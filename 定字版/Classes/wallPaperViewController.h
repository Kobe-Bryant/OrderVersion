...
@interface wallPaperViewController : UIViewController <MBProgressHUDDelegate, UIScrollViewDelegate,commandOperationDelegate,IconDownloaderDelegate,myImageViewDelegate>{
