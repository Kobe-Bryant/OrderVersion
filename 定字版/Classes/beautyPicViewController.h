...
@interface beautyPicViewController : UIViewController <commandOperationDelegate,MBProgressHUDDelegate,UIScrollViewDelegate,IconDownloaderDelegate,myImageViewDelegate>{
