...
@interface ShareToBlogViewController : UIViewController <UITextViewDelegate,MBProgressHUDDelegate,WBEngineDelegate,OpenAPiDelegate,SinaWeiboRequestDelegate>{
