...
//	// Load in all the pages
	...
	myScrollImageView *firstScrollView = [[myScrollImageView alloc] initWithFrame:CGRectMake(0.0f, fixHeight, 320.0f, BASEHEIGHT) imageName:@"%d.png" totalPic:36];
